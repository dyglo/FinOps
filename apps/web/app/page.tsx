...
import { ArrowRight, Check, CreditCard, Smartphone, Store, Wallet } from 'lucide-react';
    ...
    <div className="flex flex-col gap-32 pb-20 pt-16">
      ...
      <section className="relative grid lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-8 max-w-xl">
          <div className="flex flex-col gap-2">
            <h1 className="text-[84px] font-bold leading-[1.05] tracking-tight text-black">
              Intelligence <br />
          ...
          <div className="flex items-center gap-6">
            <Link href="/dashboard">
              <Button size="lg" className="bg-black text-white hover:bg-zinc-800 btn-pill px-8 h-14 text-base">
                Get Started
              </Button>
            </Link>
            <div className="relative h-20 w-20 flex items-center justify-center">
               <div className="absolute inset-0 animate-spin-slow">
                 <svg viewBox="0 0 100 100" className="h-full w-full">
                   ...
                   <text className="text-[10px] uppercase tracking-widest font-bold fill-black">
          ...
          <div className="flex flex-col gap-4 pt-4">
            <p className="text-sm font-medium text-gray-400">Over <span className="text-black">13,000+ Client</span> all over the world</p>
        ...
        <div className="relative h-[600px] w-full hidden lg:block">
           ...
           >
             <div className="flex justify-between items-center mb-4">
               ...
               <span className="text-[10px] text-gray-400 font-bold uppercase">View All</span>
             </div>
             <div className="flex gap-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className="h-10 w-10 rounded-full bg-gray-100 border border-white" />
                ))}
             </div>
           ...
           <motion.div 
             ...
             className="absolute top-20 right-0 w-48 bg-purple-200 rounded-3xl p-6 z-10"
           >
             <Smartphone className="h-6 w-6 mb-4" />
             <p className="text-xs font-bold opacity-60">Paypal</p>
             <p className="text-[10px] opacity-40 mb-4">Jul 09, 2022</p>
           ...
           <motion.div 
             ...
             className="absolute bottom-40 right-40 w-56 bg-lime-300 rounded-3xl p-6 z-30"
           >
             ...
             <div className="flex gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[10px] font-bold">$1327</span>
                </div>
                <div className="flex flex-col gap-1">
                  <div className="h-10 w-10 rounded-xl bg-white flex items-center justify-center"><CreditCard className="h-5 w-5" /></div>
                  <span className="text-[10px] font-bold">$3502</span>
                </div>
             </div>
           </motion.div>
           ...
           <motion.div 
             ...
             className="absolute bottom-10 right-0 w-64 bg-zinc-900 text-white rounded-3xl p-6 z-20"
           >
             <div className="flex justify-between items-start mb-8">
               <div className="flex flex-col"><span className="text-[10px] opacity-60">VISA</span><span className="text-[10px] opacity-40">Debit</span></div>
           ...
           <motion.div 
             ...
             className="absolute bottom-20 left-20 w-44 h-56 bg-gradient-to-br from-rose-200 via-orange-100 to-amber-100 rounded-3xl p-6 -rotate-6 shadow-xl"
           >
              <div className="h-8 w-8 rounded-full bg-white/20 mb-12" />
              <p className="text-[10px] font-bold opacity-60">Card number</p>
              <p className="text-xs font-bold mb-4">5737 ••••</p>
              <p className="text-[10px] font-bold opacity-60">Name</p>
              <p className="text-xs font-bold">Madhu Ma</p>
           </motion.div>

           <div className="absolute top-1/2 left-0 transform -translate-y-1/2 text-black/5">
      ...
      <section className="flex flex-col items-center gap-16">
        <div className="text-center space-y-4">
          <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Take a look at Services</p>
          <h2 className="text-5xl font-bold text-black">We provide Services</h2>
        </div>
        ...
        <div className="w-full max-w-4xl">
           ...
           <div className="grid md:grid-cols-2 gap-20 items-center">
              ...
              <div className="relative h-80 rounded-[40px] bg-gray-50 border border-gray-100 overflow-hidden">
                 <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-50 to-transparent" />
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-40 glass-card rounded-2xl flex items-center justify-center">
                    <CreditCard className="h-12 w-12 text-black/10" />
                 </div>
              </div>
           </div>
        </div>
      ...
      <section className="flex flex-col items-center gap-16">
        <div className="text-center space-y-4">
          <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Client Testimonial</p>
          <h2 className="text-5xl font-bold text-black">What they say about</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8 w-full">
           {[1,2,3].map(i => (
             <Card key={i} className="border-none shadow-none bg-white/50 p-10 rounded-[40px] space-y-6">
                <span className="text-6xl font-serif text-black/10">“</span>
                ...
                <div className="flex items-center gap-4">
                   ...
                   <div className="flex flex-col"><span className="font-bold text-black">Alex Pitter</span><span className="text-xs text-gray-400">Director, HSBC Bank</span></div>
                </div>
             </Card>
           ))}
        </div>
      ...
      <section className="flex flex-col items-center gap-16">
        <div className="text-center space-y-4">
          <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Our Blog</p>
          <h2 className="text-5xl font-bold text-black">Latest news from our blog</h2>
        </div>
...
function CircleIcon() {
  return (
    <div className="flex -space-x-3">
       <div className="h-12 w-12 rounded-full border-4 border-black bg-white flex items-center justify-center">
...
function ServiceTab({ active, icon, label }: { active?: boolean, icon: React.ReactNode, label: string }) {
  return (
    <div className={`flex items-center gap-3 px-8 py-5 rounded-2xl border transition-all cursor-pointer ${
      active ? 'bg-white shadow-xl border-white scale-105' : 'border-gray-100 hover:border-gray-200 text-gray-400'
    }`}>
      {icon}
...
function FeatureItem({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-3">
      <div className="flex-shrink-0 h-4 w-4 flex items-center justify-center rounded-full bg-black/5">
...
function BlogCard({ image, title, date }: { image: string, title: string, date: string }) {
  return (
    <div className="group cursor-pointer space-y-6">
       <div className="relative aspect-[16/9] rounded-[40px] overflow-hidden border border-gray-100">
       ...
       <div className="space-y-2">
          ...
          <h4 className="text-2xl font-bold group-hover:text-emerald-600 transition-colors">{title}</h4>
       </div>
    </div>
  )
}
